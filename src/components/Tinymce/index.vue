<template>
  <div class='tinymce-container editor-container'>
     <textarea class='tinymce-textarea' name="content" :id="id"></textarea> 
    <!--业务需求可删除-->
...
<script>
    ...
    export default {
      name: 'tinymce',
      components: { editorImage}, // 业务需求可删除
      props: {
        id: {
          type: String,
      ...
      mounted() {
        ...
        tinymce.init({
          ...
          toolbar: this.toolbar, //变一行
          menubar: this.menubar,
          plugins: 'advlist,autolink,paste,textcolor, colorpicker,link,wordcount, imagetools,watermark',
