          ...
          <el-row>
             <el-col :span="24"  style="border-bottom:transparent;"> 
                ...
                <table v-if="systemBlean" :data="formData.equipmentLists" cellpadding="0" cellspacing="0" class="el-table table-in equipment-zb" style="width:100%;">
                  ...
                  <tbody v-for="(item,index)  in formData.equipmentLists" v-if="item.logsListList && item.logsListList.length > 0">
                    <tr>
                  ...
                  <tbody  v-for="(item,index)  in formData.equipmentLists" v-if="!item.logsListList">
                    <tr>
          ...
          <el-row >
            ...
            <el-col :span="20">
              <div class="grid-content photo-div" style="height:160px;overflow:hidden;padding:0;">
              	<img v-for="(item,index)  in formData.photoVo" :src="item.fileurl" class="imgWidth" />
              </div>
            </el-col>
          </el-row>  
...
<script>
	import { getManageLogDetail } from 'api/sourceIndex';
    ...
    created(){
      ...
      getManageLogDetail(this.$route.params.id).then(res => {
        ...
        if(this.formData.equipmentLists && this.formData.equipmentLists.length > 0){
