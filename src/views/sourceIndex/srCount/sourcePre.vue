          ...
          <el-col :span="18" >
            <div class="left-Content">
              ...
              <div class="preview-box" v-if="Video" >
                ...
                <Nvideo :src="previewData.sourceUrl" :isVip="isVip" ></Nvideo>
              </div>
              ...
              <div class="preview-box2" v-if="isPic">
                ...
                <div v-loading.body="loading" style="min-height:300px;">
                  <template  v-if="!loading" >
                     <img  v-for="(item,index)  in previewData.previewUrls" :src="item" :key="'11'+index"  class="imgcls" style=""/>
                  </template>
                </div>
             ...
             <div class="link-source">
                  ...
                  <template v-if="list.length>0">
                    <div  v-for="(item,index)  in list" :key="'12'+item" class="itemBox" style="float:left;cursor:pointer" @click="toDetail(item)">
            ...
            <div class="right-Content">
              ...
              <div class="right-ContentBox">
                ...
                <div class="brief">
                  <strong>资源标签</strong>
                  <p>
                    <span v-for="(item,index)  in tags" :key="'22'+item" @click="goSearch(item)">{{item}}</span>
                  </p>
                </div>
                <div class="brief">
                  <strong>资源来源</strong>
...
import { getSourcePreviewDetail } from "api/sourceIndex";
export default {
  name: "sourcePreview",
  components: { Nvideo, MasterPage },
  data() {
    return {
      title: "",
  ...
  methods: {
    ...
    goMore() {
      if (this.orgType == "225") {
        this.$router.push({ name: "SourceIndex" });
      } else {
    ...
    goSearch(name) {
      this.$router.push({ name: "SearchSrc", params: { sourceName: name } });
    },
