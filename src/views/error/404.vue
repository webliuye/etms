<template>
  <master-page title="40000000004">
  <div style="background:#f0f2f5;margin-top: -20px;">
    <div class="wscn-http404">
      <div class="pic-404">
       <img src="~assets/img/404pic.png">
      </div>
      <div class="bullshit">
        <div class="bullshit__oops">抱歉，你访问的页面不存在</div>
        <div class="bullshit__headline"></div>
        <div class="bullshit__info"></div>
        <a  class=" el-button" @click="goBack">返回上一页</a>  <a>   </a> <el-button type="primary" @click="goHome">返回首页</el-button> 
      </div>
    </div>
  </div>
  </master-page>
